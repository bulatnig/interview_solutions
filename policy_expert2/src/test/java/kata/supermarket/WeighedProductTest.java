...
class WeighedProductTest {
    ...
    void itemFromWeighedProductHasExpectedUnitPrice(String pricePerKilo, String weightInKilos, String expectedPrice) {
        ...
        final Item weighedItem = new ItemByWeight(weighedProduct, new BigDecimal(weightInKilos));
        assertEquals(new BigDecimal(expectedPrice), weighedItem.priceWithDiscount());
    }
